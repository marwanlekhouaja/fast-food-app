...
const Why = () => {
  ...
  const paragraph = "Lorem, ipsum dolor non vel excepturi voluptas veniam";
  const benefits = [
    { id: 1, name: "Fresh and tasty foods" },
    { id: 2, name: "Quality support" },
    { id: 3, name: "Order from any location" },
  ];
        ...
        <div style={styleP} className="col-12 col-md-10">
          ...
          <div className="advantages mt-3">
            {benefits.map((benefit) => (
              <div key={benefit.id}>
                <h5>
                  <span className="p-1 bg-light rounded-pill text-danger me-1">
                    <MdOutlineDone />
                  </span>
                  {benefit.name}
                </h5>
